        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InventoryStatus = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblCartProducts", x => new { x.CartId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_tblCartProducts_tblCarts_CartId",
                        column: x => x.CartId,
                        principalTable: "tblCarts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_tblCartProducts_tblProducts_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tblCartProducts_ProductId",
