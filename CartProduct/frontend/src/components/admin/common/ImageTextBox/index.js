...
const ImageTextInput = ({refFormik, ...props}) => {
    ...
    const [src, setSrc] = useState( props.src ? "images/" + props.src :"https://bytes.ua/wp-content/uploads/2017/08/no-image.png");

   const drag = useSelector(redux => redux.drag);
        ...
        <div className="row">
            <div className="offset-3 col-md-6">
                <label htmlFor={props.name || props.id} className="d-flex justify-content-center">
                    ...
                    className={classNames({"borderSolid": !drag.isDrag}, {"borderDashed":drag.isDrag})}
                    />
                </label>
